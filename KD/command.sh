...
# Selector Model large True - GraphSAGE, PLP
python3 -u selector_pretrain.py --lr 0.01 --wd 0.001 --margin 0.3 --ms1 500 --ms2 750 --gm 0.1 --nlayer 7
python3 -u selector_pretrain.py --large True --lr 0.01 --wd 0.001 --nlayer 7